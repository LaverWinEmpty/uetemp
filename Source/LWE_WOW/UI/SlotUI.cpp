...
//UWidget* USlotUI::Get(const TCHAR* const InName)
//{
//}
...
void USlotUI::NativeOnMouseEnter(const FGeometry& In, const FPointerEvent& InEvent)
{
    Super::NativeOnMouseEnter(In, InEvent);
}

void USlotUI::NativeOnMouseLeave(const FPointerEvent& InEvent)
{
    Super::NativeOnMouseLeave(InEvent);
}

FReply USlotUI::NativeOnMouseMove(const FGeometry& In, const FPointerEvent& InEvent)
{
...
//void USlotUI::OnGeometryChanged(const FGeometry& OldGeometry)
//{
